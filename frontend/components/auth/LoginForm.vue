      ...
      <div class="bg-gray-100 p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <form class="space-y-4 md:space-y-6">
          <div>
            ...
            <input v-model="login" type="text" name="login" id="login" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="name@company.com" required="">
          </div>
          <div>
          ...
          <p class="text-sm font-light text-gray-500">
            Ещё не зарегистрированы? <nuxt-link to="/signup" class="font-medium text-primary-600 hover:underline">Зарегистрируйтесь здесь</nuxt-link>
          </p>
        </form>
      </div>
    </div>
